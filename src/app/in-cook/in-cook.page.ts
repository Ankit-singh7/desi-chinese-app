...
@Component({
  selector: 'app-in-cook',
  templateUrl: './in-cook.page.html',
  styleUrls: ['./in-cook.page.scss'],
})
export class InCookPage extends RouterPage {
  public billArray = [];
  userName: any;
  ...
  constructor(private platform: Platform,
    ...
    async getAllBills(){
      ...
      loader.present().then(() => {
        this.invoiceService.getAllInCookBill().subscribe((res) => {
            if(res.data) {
